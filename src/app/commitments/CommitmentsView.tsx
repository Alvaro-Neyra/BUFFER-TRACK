...
export function CommitmentsView({ commitments, statuses, projectsList, currentProjectId, isManager }: CommitmentsViewProps) {
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    <div className="p-6 md:p-8 pb-0 shrink-0">
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                <div className="relative flex-1 sm:w-72">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Search commitments by task, ID, location, specialty or assignee..."
                                        value={commitmentSearchTerm}
                                        onChange={(e) => setCommitmentSearchTerm(e.target.value)}
                        ...
                        <div className="flex flex-wrap items-end justify-between gap-3 border-b border-neutral-200 dark:border-neutral-800">
                            <p className="pb-3 text-sm font-bold border-b-2 border-primary text-primary">Commitments</p>
                            <button
                                type="button"
