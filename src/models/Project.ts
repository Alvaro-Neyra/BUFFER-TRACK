...
export interface IProject extends Document {
    ...
    masterPlanCloudinaryPublicId?: string;
    configuration: {
        startWeek: Date;
        endWeek: Date;
    };
...
// masterPlanCloudinaryPublicId keeps a direct storage reference to enable
// deterministic cleanup when replacing/deleting the master plan image.
const ProjectSchema: Schema = new Schema(
    {
        ...
        masterPlanCloudinaryPublicId: { type: String },
        configuration: {
